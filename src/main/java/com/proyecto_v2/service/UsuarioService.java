package com.proyecto_v2.service;
...
import com.proyecto_v2.entity.Usuario;
import com.proyecto_v2.exception.BadRequestException;
import com.proyecto_v2.exception.ResourceNotFoundException;
import com.proyecto_v2.interfaces.InterfaceUsuarioService;
import com.proyecto_v2.repository.RolRepository;
import com.proyecto_v2.repository.UsuarioRepository;
import com.proyecto_v2.security.JwtService;
import com.proyecto_v2.util.JsonPrinter;
...
public class UsuarioService implements InterfaceUsuarioService {
    ...
    @Transactional
    public TokenDtoSalida crearUsuarioConRol(UsuarioDtoEntrada usuarioDTOEntrada, String rol) {
        ...
        Roles roles = rolRepository.findByRol(rol)
                .orElseGet(() -> rolRepository.save(new Roles(rol)));

        // Asignar el rol al usuario
        usuarioEntidad.setRoles(Collections.singleton(roles));
