...
import com.proyecto_v2.AppProyecto_v2;
import com.proyecto_v2.exception.InvalidTokenException;
import com.proyecto_v2.exception.UnauthorizedException;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            throw new UnauthorizedException("Usuario sin autorización para acceder a este recurso");
